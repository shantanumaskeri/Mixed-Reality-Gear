...
public class TransitionManager : MonoBehaviour
{
    ...
    void Update () 
    {
        ...
        if ((mCurrentMode != mixedRealityMode) || (InAR != isVideoCurrentlyEnabled))
        {
            ...
            {
				MonoBehaviour[] ma = GameObject.Find ("ARCamera").GetComponents<MonoBehaviour>();
				foreach (MonoBehaviour m in ma)
				{
					m.enabled = false;
				}

				backgroundPlane.GetComponent<MeshRenderer>().enabled = false;

				if (GameObject.Find ("TextureBufferMesh") != null)
				{
					GameObject.Find ("TextureBufferMesh").GetComponent<MeshRenderer>().enabled = false;
				}
                ...
                || mCurrentMode == MixedRealityController.Mode.VIEWER_AR)
            {
				...
				backgroundPlane.GetComponent<MeshRenderer>().enabled = true;

				if (GameObject.Find ("TextureBufferCamera") != null)
				{
					GameObject.Find ("TextureBufferMesh").GetComponent<MeshRenderer>().enabled = true;
				}
